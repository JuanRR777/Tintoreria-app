...
const ICONS = {
  ...
  info:    `<svg class="toast-icon info"    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`,
}
...
function show(message, type = 'info', duration = 3500) {
  ...
  el.innerHTML = `${ICONS[type] || ICONS.info}<span class="toast-message">${message}</span>`
